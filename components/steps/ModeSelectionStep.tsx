    ...
    <div className="space-y-6 pt-10 px-6 step-transition overflow-y-auto pb-10">
      ...
      <div className="grid gap-4">
        ...
        >
          ...
          <p className="text-slate-400 text-xs mt-1">남은 재료로 만드는 기적의 레시피</p>
        </button>
        ...
        >
          ...
          <p className="text-slate-400 text-xs mt-1">지금 가장 맛있는 재료 추천받기</p>
        </button>
        ...
        >
          ...
          <p className="text-slate-400 text-xs mt-1">편의점 재료로 만드는 초간단 맛도리</p>
        </button>
      </div>
